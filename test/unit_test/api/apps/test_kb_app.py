...
from api.utils.api_utils import get_json_result, get_data_error_result, get_error_data_result
...
class TestKbAppPipelineLogs:
    ...
    def test_pipeline_log_detail_missing_log_id(self):
        ...
        result = get_json_result(data=False, message='Lack of "Pipeline log ID"', code=RetCode.ARGUMENT_ERROR)
        result_json = _get_result_json(result)
...
class TestKbAppUnbindTask:
    ...
    def test_unbind_task_missing_kb_id(self):
        ...
        # get_error_data_result returns DATA_ERROR (102), not ARGUMENT_ERROR (101)
        assert result_json.get("code") == RetCode.DATA_ERROR
...
class TestResponseHelpers:
    ...
    def test_get_json_result_with_code(self):
        ...
        result = get_json_result(data=False, code=RetCode.DATA_ERROR)
        result_json = _get_result_json(result)
